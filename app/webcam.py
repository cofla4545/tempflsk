...
video_out_path = "static/output/output_webcam.mp4"
audio_out_path = "static/output/output_webcam_audio.wav"
output_path = "static/output/output_webcam_with_audio.mp4"

# 기존 파일 삭제
if os.path.exists(video_out_path):
    os.remove(video_out_path)
    print(f"Deleted existing file: {video_out_path}")

if os.path.exists(audio_out_path):
    os.remove(audio_out_path)
    print(f"Deleted existing file: {audio_out_path}")
